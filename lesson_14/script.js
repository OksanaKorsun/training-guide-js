...
// event.target.nodeName !== 'BUTTON' - якщо в нас є елемент з делегованим прослуховувачем і потрібно потрапити
// саме на кнопку
// зняти клас сусіднього елемента - event.target.nextElementSibling.classList.toggle("active")
